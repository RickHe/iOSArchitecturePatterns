...
- (void)viewDidLoad {
    ...
    _tableViewItems = @[
                         [[RHTableViewItem alloc] initWithTitle:@"MVC" className:@"RHTestMVCViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"MVP" className:@"RHTestMVPViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"MVVM" className:@"RHTestMVVMViewController"],
                         [[RHTableViewItem alloc] initWithTitle:@"VIPER" className:@"RHTestVIPERViewController"],
                         ];
